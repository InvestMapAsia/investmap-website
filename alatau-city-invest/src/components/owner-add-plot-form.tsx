...
export function OwnerAddPlotForm() {
  ...
  const t = pickLang(lang, {
    ...
    CN: {
      ...
      roi: "ROI (%)",
      irr: "IRR (%)",
      distanceCenterKm: "到中心距离 (km)",
      legalOwnerType: "法律业主类型",
      utilitiesConfirmed: "公用设施已确认",
      description: "描述",
      mapAddress: "地图地址或地点",
      mapLat: "纬度",
      mapLng: "经度",
      openGoogleMap: "在 Google Maps 中打开",
      mapHint: `Alatau 范围：纬度 ${ALATAU_BOUNDS.minLat}..${ALATAU_BOUNDS.maxLat}，经度 ${ALATAU_BOUNDS.minLng}..${ALATAU_BOUNDS.maxLng}。`,
      mediaSection: "地块媒体（照片/视频）",
      mediaHint: "文件会上传到 Vercel Blob，公开链接将保存到该 listing。",
      coverSection: "16:9 封面照片（可选）",
      coverHint: "上传一张横向图片作为 listing 封面。推荐比例：16:9。",
      panoramaSection: "360 全景照片",
      panoramaHint: "上传 equirectangular 360 照片，它们会在地块详情页单独展示。",
      mediaUploading: "文件上传中...",
      mediaUploaded: "已上传文件",
      removeMedia: "移除",
      openMedia: "打开",
      ...
      purposeCommercial: "商业",
      purposeMixed: "混合用途",
      purposeResidential: "住宅",
      purposeLogistics: "物流",
      purposeIndustrial: "工业",
      ownerIndividual: "个人",
      ownerCompany: "公司",
      ownerPpp: "PPP",
      yes: "是",
      no: "否",
      submitError: "创建业主 listing 失败，请检查必填字段。",
      invalidArea: "面积必须是大于 0 的有效数字。",
      invalidPrice: "价格必须是有效数字且不少于 10,000 USD。",
      invalidCoordinatesPair: "请同时填写纬度和经度，或两项都留空。",
      invalidCoordinatesRange: `坐标必须在 Alatau 范围内：纬度 ${ALATAU_BOUNDS.minLat}..${ALATAU_BOUNDS.maxLat}，经度 ${ALATAU_BOUNDS.minLng}..${ALATAU_BOUNDS.maxLng}。`,
      unauthorized: "会话已过期，请重新登录。",
      forbidden: "只有业主或管理员账户可以提交土地 listing。",
      errorDetailsTitle: "服务器返回：",
      submitting: "提交中...",
      submit: "提交审核",
      choosePricing: "选择收费方案",
      successTitle: "地块已成功提交。",
      status: "状态",
      quality: "质量评分",
      openOwnerCabinet: "打开业主柜台",
    },
  });
