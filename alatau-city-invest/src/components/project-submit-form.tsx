...
export function ProjectSubmitForm() {
  ...
  const t = pickLang(lang, {
    ...
    KZ: {
      readiness: "Дайынды? ба?асы",
      companyName: "1. Компания атауы",
      businessOverview: "2. Бизнес сипаттамасы",
      market: "3. На?ты нары?",
      businessModel: "4. Бизнес-модель",
      traction: "5. Прототип немесе ал?аш?ы н?тижелер",
      legalReadiness: "6. За?ды? дайынды?",
      financialForecasts: "7. ?аржылы? болжамдар",
      investmentTerms: "8. Инвестиция шарттары",
      founderName: "??рушыны? аты-ж?ні",
      founderEmail: "??рушы email",
      founderPhone: "??рушы телефоны",
      city: "?ала",
      website: "Сайт",
      requestedAmount: "?ажетті сома (USD)",
      minimumTicket: "Минималды билет (USD)",
      submit: "Жобаны жіберу",
      submitting: "Жіберілуде...",
      submitError: "Жобаны жіберу с?тсіз. Міндетті ?рістерді тексері?із.",
      unauthorized: "Алдымен ж?йеге кірі?із.",
      success: "Жоба модерация?а жіберілді.",
      status: "Статус",
