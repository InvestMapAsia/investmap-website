...
export function ProjectSubmitForm() {
  ...
  const t = pickLang(lang, {
    ...
    CN: {
      readiness: "准备度评分",
      companyName: "1. 公司名称",
      businessOverview: "2. 业务介绍",
      market: "3. 目标市场",
      businessModel: "4. 商业模式",
      traction: "5. 原型或初步成果",
      legalReadiness: "6. 法律准备度",
      financialForecasts: "7. 财务预测",
      investmentTerms: "8. 投资条款",
      founderName: "创始人全名",
      founderEmail: "创始人邮箱",
      founderPhone: "创始人电话",
      city: "城市",
      website: "网站",
      requestedAmount: "融资需求 (USD)",
      minimumTicket: "最低投资额 (USD)",
      mediaLinks: "照片/视频链接（每行一个 URL）",
      submit: "提交项目",
      submitting: "提交中...",
      submitError: "项目提交失败，请检查必填字段。",
      unauthorized: "请先登录。",
      success: "项目已提交审核。",
      status: "状态",
      openProjects: "打开项目展示",
      openInvestorCabinet: "打开投资人柜台",
    },
  });
