...
export function ProjectsCabinet() {
  ...
  const t = pickLang(lang, {
    ...
    CN: {
      unauthorized: "请登录后查看项目柜台。",
      title: "我的项目提交",
      sub: "查看已提交项目、审核状态和审核意见。",
      total: "提交总数",
      onReview: "审核中",
      approved: "已批准",
      revisions: "需要修改",
      ...
      needsRevision: "需要修改",
      rejected: "已拒绝",
      searchPlaceholder: "按公司或市场搜索",
      search: "搜索",
      reset: "重置",
      submitProject: "提交新项目",
      openMarketplace: "打开项目市场",
      projectList: "提交列表",
      noData: "暂无项目。提交第一个项目开始审核。",
      id: "ID",
      company: "公司",
      market: "市场",
      amount: "融资需求",
      ...
      businessModel: "商业模式",
      traction: "原型 / 初步成果",
      legalReadiness: "法律准备度",
      financialForecasts: "财务预测",
      investmentTerms: "投资条款",
      moderationNote: "审核员备注",
      noModerationNote: "暂无审核备注。",
      timeline: "状态时间线",
      submittedEvent: "项目已提交",
      reviewedEvent: "最新审核更新",
      emptyRight: "从列表中选择项目。",
      viewProjectsBoard: "查看项目看板",
      openProjectPage: "打开项目页面",
      edit: "编辑",
      editTitle: "编辑项目",
      editSub: "修改会重新提交审核，管理员批准后才会展示。",
      saveChanges: "提交修改",
      cancel: "取消",
      changesSubmitted: "项目修改已提交审核。",
      editError: "提交项目修改失败。",
      mediaLinks: "照片/视频链接",
      mapAddress: "地图地址",
      mapLat: "纬度",
