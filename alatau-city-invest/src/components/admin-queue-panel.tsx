...
export function AdminQueuePanel() {
  ...
  const t = pickLang(lang, {
    EN: {
      ...
      projectQueue: "Small projects queue",
      ...
      projectTitle: "Small project moderation",
      projectSub: "Review ordinary business projects, update status and provide moderation notes.",
      company: "Company",
      market: "Market",
      requested: "Requested",
      founder: "Founder",
      moderationNote: "Moderation note",
      noProjects: "No small projects yet.",
    ...
    RU: {
      ...
      projectQueue: "Очередь малых проектов",
      ...
      projectTitle: "Модерация малых проектов",
      projectSub: "Проверяйте обычные бизнес-проекты, меняйте статус и оставляйте комментарий модератора.",
      company: "Компания",
      market: "Рынок",
      requested: "Запрос",
      founder: "Основатель",
      moderationNote: "Комментарий модерации",
      noProjects: "Пока нет малых проектов.",
    ...
    KZ: {
      ...
      appQueue: "?тінім кезегі",
      projectQueue: "Ша?ын жобалар кезегі",
      auditEvents: "Аудит о?и?алары",
      queueTitle: "Учаскелер модерациясы",
      queueSub: "Жер иелері мен платформа листингтеріне арнал?ан ?кімші ?дерісі.",
      id: "ID",
      plot: "Учаске",
      ownerType: "Иесі т?рі",
      status: "Статус",
      updated: "Жа?артылды",
      newStatus: "Жа?а статус",
      queueEmpty: "Модерация кезегі бос.",
      appTitle: "?тінім модерациясы",
      appSub: "?тінім статустарын жа?артып, инвестор?а ескертпе ?алдыры?ыз.",
      investor: "Инвестор",
      amount: "Сома",
      reviewNote: "Ескертпе",
      update: "Жа?арту",
      optionalNote: "?осымша ескертпе",
      noApplications: "Модерация?а ?тінім жо?.",
      projectTitle: "Ша?ын жоба модерациясы",
      projectSub: "К?дімгі бизнес-жобаларды ?арап, статусын ?згертіп, модератор т?сіндірмесін бері?із.",
      company: "Компания",
      market: "Нары?",
      requested: "С?раныс",
      founder: "??рушы",
      moderationNote: "Модерация ескертпесі",
      noProjects: "?зірге ша?ын жобалар жо?.",
      auditTitle: "Аудит журналы",
      auditSub: "Инвестор, жер иесі ж?не ?кімші ?рекеттеріні? ?згермейтін журналы.",
      loadingAudit: "Аудит деректері ж?ктелуде...",
      time: "Уа?ыт",
      action: "?рекет",
      entity: "Нысан",
      actorRole: "Р?л",
      actorUser: "Пайдаланушы",
      noAudit: "?зірге аудит о?и?алары жо?.",
      updatePlotError: "Учаске статусын жа?арту с?тсіз.",
      updateAppError: "?тінім статусын жа?арту с?тсіз.",
      updateProjectError: "Жоба статусын жа?арту с?тсіз.",
      statusDraft: "Черновик",
      statusSubmitted: "Жіберілді",
      statusKyc: "KYC/AML",
      statusLegal: "За? тексерісі",
      statusApproved: "Ма??лданды",
      statusRejected: "?абылданбады",
      plotAvailable: "?олжетімді",
      plotReserved: "Резерв",
      plotDeal: "М?міледе",
      plotModeration: "Модерация",
      plotSold: "Сатыл?ан",
      plotLegalIssue: "За?ды? м?селе",
      projectSubmitted: "Жіберілді",
      projectUnderReview: "?аралуда",
      projectNeedsRevision: "Т?зету керек",
      projectApproved: "Ма??лданды",
      projectRejected: "?абылданбады",
    },
  });
