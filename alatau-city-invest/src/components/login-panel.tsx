  ...
  const t = useMemo(
    () =>
      pickLang(lang, {
        ...
        CN: {
          invalid: "登录信息无效。",
          emailNotVerified: "请先确认邮箱。检查收件箱后再试。",
          regFailed: "注册失败。",
          regSuccess: "注册成功。请检查邮箱并确认账户。",
          regSuccessPreview: "注册成功。邮件服务未配置，请使用下方预览链接。",
          regNoEmail: "注册已完成，但验证邮件未发送。请联系支持团队。",
          verifySuccess: "邮箱已确认，现在可以登录。",
          verifyInvalid: "验证链接无效。",
          verifyExpired: "验证链接已过期。请输入邮箱并请求新的链接。",
          resend: "重新发送验证邮件",
          resendWait: "发送中...",
          resendNeedEmail: "请先输入邮箱，再请求新的验证链接。",
          resendSuccess: "验证邮件已发送，请检查收件箱。",
          resendSuccessPreview: "邮件服务未配置，请使用下方预览验证链接。",
          resendAlreadyVerified: "该邮箱已验证，可以登录。",
          resendFailed: "无法重新发送验证邮件。",
          resendNoEmail: "无法发送验证邮件。请检查 Vercel 和 Resend 邮件设置。",
          login: "登录",
          register: "注册",
          policyRequired: "请接受平台政策和条款后创建账户。",
          policyPrefix: "我同意",
          policyLink: "平台政策、隐私规则和投资风险提示",
          name: "姓名",
          email: "邮箱",
          password: "密码",
          role: "角色",
