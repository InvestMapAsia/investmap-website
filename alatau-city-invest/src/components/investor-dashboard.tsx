...
export function InvestorDashboard() {
  ...
  const t = pickLang(lang, {
    ...
    RU: {
      ...
      notificationsSub: "Внутренние уведомления и сгенерированные письма для важных этапов процесса.",
      ...
      favoriteSub: "Сохранённый шорт-лист для быстрого сравнения и инвестирования.",
    ...
    KZ: {
      ...
      startKyc: "KYC бастау",
      starting: "Басталуда...",
      noProfile: "Алдымен толық профилмен кіріңіз.",
