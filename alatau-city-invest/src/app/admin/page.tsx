...
export default function AdminPage() {
  ...
  const t = pickLang(lang, {
    EN: {
      ...
      sub: "Moderation, legal incidents, owner listings and inventory control in one workspace.",
      sla: "Operational SLA",
    ...
    RU: {
      ...
      sub: "Модерация, юридические инциденты, листинги собственников и контроль инвентаря в одном окне.",
    ...
    KZ: {
      ...
      sub: "Модерация, заңдық инциденттер, жер иелері листингтері және инвентарь бақылауы бір кеңістікте.",
      sla: "Операциялық SLA",
