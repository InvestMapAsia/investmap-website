...
export default function AlatauCityPage() {
  ...
  const t = pickLang(lang, {
    EN: {
      ...
      subtitle:
        "A commercial-grade project page with map intelligence, AI risk guidance, owner self-listing, investor workflows, and admin moderation.",
      openMap: "Open map",
      ...
      coreIndicators: "Core Alatau City indicators",
      ...
      mapTitle: "Alatau City investment map",
      mapSub: "Explore verified land plots by purpose, legal status, risk level and pricing profile.",
    ...
    RU: {
      ...
      subtitle:
        "Страница проекта коммерческого уровня с картой, AI-анализом рисков, самостоятельным размещением участков, кабинетами инвестора и модерацией.",
      ...
      coreIndicators: "Ключевые показатели Alatau City",
      ...
      mapTitle: "Инвестиционная карта Alatau City",
      mapSub: "Изучайте проверенные участки по назначению, юридическому статусу, риску и цене.",
    ...
    KZ: {
      ...
      subtitle:
        "Карта, AI тәуекел талдауы, жерді өз бетінше орналастыру, инвестор кабинеті және модерациясы бар жоба беті.",
      openMap: "Картаны ашу",
      ...
      coreIndicators: "Alatau City негізгі көрсеткіштері",
      ...
      mapTitle: "Alatau City инвестициялық картасы",
      mapSub: "Тексерілген жерлерді мақсат, заңдық статус, тәуекел және баға бойынша қараңыз.",
    ...
    CN: {
      title: "以透明法律核验和高级分析投资 Alatau City 土地",
      subtitle:
        "商业级项目页面，包含地图智能、AI 风险指引、业主自助挂牌、投资者流程和后台审核。",
      openMap: "打开地图",
      browseCatalog: "浏览目录",
      addLand: "添加土地",
      smallProjects: "项目",
      legallyVerified: "法律已核验地块",
      moderationSla: "审核 SLA",
      averageForecastRoi: "平均预测 ROI",
      partners: "合作机构",
      coreIndicators: "Alatau City 核心指标",
      coreIndicatorsSub: "关于库存、机会质量和交易流的实时摘要。",
      availableLots: "可用地块",
      totalInventory: "总库存",
      avgRoiLabel: "平均 ROI",
      pipelineApplications: "流程中申请",
      realtimeCabinet: "柜台实时更新",
      mapTitle: "Alatau City 投资地图",
      mapSub: "按用途、法律状态、风险等级和价格画像探索已核验地块。",
      topPlots: "本周优选地块",
      topPlotsSub: "按 ROI、法律画像和基础设施动能筛选。",
      roadmap: "区域路线图",
      road1: "交通枢纽与物流加速阶段。",
      road2: "燃气和供水主干网络扩建。",
      road3: "教育和医疗健康锚点项目。",
  ...
  return (
    <div className="container">
        ...
        <div className="hero-grid">
          <div>
            ...
            <div className="inline-actions">
              <a className="btn btn-primary" href="#alatau-map">
                {t.openMap}
              </a>
      ...
      <section className="section" id="alatau-map">
        <div className="section-title">
          <h2>{t.mapTitle}</h2>
          <p>{t.mapSub}</p>
        </div>
